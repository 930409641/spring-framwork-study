...
1. IntelliJ (Fil Precompile `spring-oxm` with `./gradlew :spring-oxm:compileTestJava`
2. Import intoe -> New -> Project from Existing Sources -> Navigate to directory -> Select build.gradle)
